...
export const NATIONAL_DAY_96_BANK: NationalDayQuestion[] = [
  {
    ...
    difficulty: 'easy', points: 10, timeLimitSeconds: 15, status: 'ACTIVE', usedCount: 0, createdAt: Date.now()
  },
  {
    ...
    difficulty: 'medium', points: 10, timeLimitSeconds: 15, status: 'ACTIVE', usedCount: 0, createdAt: Date.now()
  },
  {
